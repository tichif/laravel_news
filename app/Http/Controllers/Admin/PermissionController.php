...
class PermissionController extends Controller
{
    ...
    {
        $page_name = " Permission Page";
        $data = Permission::all();
        return view('admin.pages.permission.list', compact('data','page_name'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.pages.permission.edit', compact('page_name', 'permission'));
    }
