...
<div class="widget hidden-xs m30">
  ...
  <img class="img-responsive adv_img" src="{{asset('front/img/right_add3.jpgg')}}" alt="add_one">
...
<div class="widget m30">
  ...
  <div class="media">
      <div class="media-left">
          <a href="#"><img class="media-object" src="{{asset('front/img/pop_right4.jpgg')}}" alt="Generic placeholder image"></a>
      </div>
      <div class="media-body">
          <h3 class="media-heading">
              <a href="single.html" target="_blank">DSLR is the most old camera at this time readmore about new
